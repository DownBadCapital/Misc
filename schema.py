...
NAUTILUS_PARQUET_SCHEMA = {
    ...
    TradeTick: pa.schema(
        {
            ...
            "price": pa.string(),
            "size": pa.string(),
            "aggressor_side": pa.dictionary(pa.int64(), pa.string()),
            "trade_id": pa.string(),
            "ts_event": pa.uint64(),
            "ts_init": pa.uint64(),
        },
    ...
    Bar: pa.schema(
        {
            "bar_type": pa.dictionary(pa.int64(), pa.string()),
            "instrument_id": pa.dictionary(pa.int64(), pa.string()),
            "open": pa.string(),
            "high": pa.string(),
            "low": pa.string(),
    ...
    VenueStatusUpdate: pa.schema(
        {
            "venue": pa.dictionary(pa.int64(), pa.string()),
    ...
    InstrumentClosePrice: pa.schema(
        {
            "instrument_id": pa.dictionary(pa.int64(), pa.string()),
            "close_type": pa.dictionary(pa.int64(), pa.string()),
    ...
    ComponentStateChanged: pa.schema(
        {
            "trader_id": pa.dictionary(pa.int64(), pa.string()),
            "component_id": pa.dictionary(pa.int64(), pa.string()),
            "component_type": pa.dictionary(pa.int64(), pa.string()),
            "state": pa.string(),
            "config": pa.string(),
            "event_id": pa.string(),
            "ts_event": pa.uint64(),
    ...
    AccountState: pa.schema(
        {
            "account_id": pa.dictionary(pa.int64(), pa.string()),
            "account_type": pa.dictionary(pa.int64(), pa.string()),
            "base_currency": pa.dictionary(pa.int64(), pa.string()),
            "balance_total": pa.float64(),
            "balance_locked": pa.float64(),
            "balance_free": pa.float64(),
            "balance_currency": pa.dictionary(pa.int64(), pa.string()),
            "margin_initial": pa.float64(),
            "margin_maintenance": pa.float64(),
            "margin_currency": pa.dictionary(pa.int64(), pa.string()),
    ...
    OrderInitialized: pa.schema(
        {
            "trader_id": pa.dictionary(pa.int64(), pa.string()),
            "strategy_id": pa.dictionary(pa.int64(), pa.string()),
            "instrument_id": pa.dictionary(pa.int64(), pa.string()),
            "client_order_id": pa.string(),
            "order_side": pa.dictionary(pa.int64(), pa.string()),
            "order_type": pa.dictionary(pa.int64(), pa.string()),
            "quantity": pa.float64(),
            "time_in_force": pa.dictionary(pa.int64(), pa.string()),
            "post_only": pa.bool_(),
            "reduce_only": pa.bool_(),
            # -- Options fields -- #
            "price": pa.float64(),
            "trigger_price": pa.string(),
            "trigger_type": pa.dictionary(pa.int64(), pa.string()),
            "limit_offset": pa.string(),
            "trailing_offset": pa.string(),
            "trailing_offset_type": pa.dictionary(pa.int64(), pa.string()),
    ...
    OrderDenied: pa.schema(
        {
            ...
            "instrument_id": pa.dictionary(pa.int64(), pa.string()),
            "client_order_id": pa.string(),
            "reason": pa.dictionary(pa.int64(), pa.string()),
            "event_id": pa.string(),
            "ts_init": pa.uint64(),
        }
    ),
    ...
    CurrencyPair: pa.schema(
        {
            ...
            "base_currency": pa.dictionary(pa.int64(), pa.string()),
            "quote_currency": pa.dictionary(pa.int64(), pa.string()),
            "price_precision": pa.int64(),
            "size_precision": pa.int64(),
            "price_increment": pa.dictionary(pa.int64(), pa.string()),
            "size_increment": pa.dictionary(pa.int64(), pa.string()),
            "lot_size": pa.dictionary(pa.int64(), pa.string()),
            "max_quantity": pa.dictionary(pa.int64(), pa.string()),
            "min_quantity": pa.dictionary(pa.int64(), pa.string()),
            "max_notional": pa.dictionary(pa.int64(), pa.string()),
            "min_notional": pa.dictionary(pa.int64(), pa.string()),
            "max_price": pa.dictionary(pa.int64(), pa.string()),
            "min_price": pa.dictionary(pa.int64(), pa.string()),
    ...
    CryptoPerpetual: pa.schema(
        {
            ...
            "base_currency": pa.dictionary(pa.int64(), pa.string()),
            "quote_currency": pa.dictionary(pa.int64(), pa.string()),
            "settlement_currency": pa.dictionary(pa.int64(), pa.string()),
            "is_inverse": pa.bool_(),
            "price_precision": pa.int64(),
            "size_precision": pa.int64(),
            "price_increment": pa.dictionary(pa.int64(), pa.string()),
    ...
    CryptoFuture: pa.schema(
        {
            "id": pa.dictionary(pa.int64(), pa.string()),
            "native_symbol": pa.string(),
            "underlying": pa.dictionary(pa.int64(), pa.string()),
            "quote_currency": pa.dictionary(pa.int64(), pa.string()),
            "settlement_currency": pa.dictionary(pa.int64(), pa.string()),
    ...
    Equity: pa.schema(
        {
            "id": pa.dictionary(pa.int64(), pa.string()),
            "native_symbol": pa.string(),
            "currency": pa.dictionary(pa.int64(), pa.string()),
            "price_precision": pa.int64(),
            "size_precision": pa.int64(),
            "price_increment": pa.dictionary(pa.int64(), pa.string()),
            "size_increment": pa.dictionary(pa.int64(), pa.string()),
            "multiplier": pa.dictionary(pa.int64(), pa.string()),
            "lot_size": pa.dictionary(pa.int64(), pa.string()),
            "isin": pa.string(),
            "margin_init": pa.string(),
            "margin_maint": pa.string(),
    ...
    Future: pa.schema(
        {
            ...
            "native_symbol": pa.string(),
            "underlying": pa.dictionary(pa.int64(), pa.string()),
            "asset_class": pa.dictionary(pa.int64(), pa.string()),
            "currency": pa.dictionary(pa.int64(), pa.string()),
            "price_precision": pa.int64(),
            "size_precision": pa.int64(),
            "price_increment": pa.dictionary(pa.int64(), pa.string()),
    ...
    Option: pa.schema(
        {
            ...
            "kind": pa.dictionary(pa.int64(), pa.string()),
            "ts_event": pa.uint64(),
            "ts_init": pa.uint64(),
        }
    ),
